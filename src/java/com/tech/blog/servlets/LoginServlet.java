...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            User req_user = dao.getUserByEmailAndPassword(email, pass);
            ...
            if(req_user == null){
                ...
                session.setAttribute("current_user", req_user);
                response.sendRedirect("http://localhost:8080/TechBlog/profile.jsp");
